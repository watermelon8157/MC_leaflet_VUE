...
namespace RCS_Data
{
    ...
    #region MySQLDB Provider

    //public class MySQLDBConnector : DBConnector
    //{
    //    public MySQLDBConnector(string ConnectionString, ILog Logger = null, int? DefaultTimeout = null) : base(new MySQLDBProvider(), ConnectionString, Logger, DefaultTimeout)
    //    {
    ...
    //    public enmDBAProvider enmDBType { get { return enmDBAProvider.MySQL; } }
