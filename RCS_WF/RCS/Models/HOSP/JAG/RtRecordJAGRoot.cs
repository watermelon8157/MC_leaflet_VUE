...
namespace RCS.Models.JAG
{
    ...
    {
        public static string RtRecordJAGRoot { get { return Function_Library.GetClassDisplayName<RtRecordJAGRoot>(); } }
    }

    [DisplayName("RtRecordJAGRoot")]
    public class RtRecordJAGRoot : JAGRoot
    {
        public RtRecordJAGRoot()
        {

        }

        public RtRecordJAGRoot(DB_RCS_RT_CASE pPat, UPLOADSTAYBYUPLOADLIST  pUploadItem, UserInfo pUser): base()
        {
            this.RequestDocType = "MRF0320015A001";
