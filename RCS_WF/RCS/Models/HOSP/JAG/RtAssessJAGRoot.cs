...
namespace RCS.Models.JAG
{
    ...
    {
        public static string RtAssessJAGRoot { get { return Function_Library.GetClassDisplayName<RtAssessJAGRoot>(); } }
    }

    [DisplayName("RtAssessJAGRoot")]
    public class RtAssessJAGRoot : JAGRoot
    {
        public RtAssessJAGRoot()
        {

        }
        public RtAssessJAGRoot(DB_RCS_RT_CASE pPat, UPLOADSTAYBYUPLOADLIST pUploadItem, UserInfo pUser) : base()
        {
            this.RequestDocType = "MRF0320019A002";
