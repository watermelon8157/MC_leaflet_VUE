...
namespace RCS_Data.Models.DB
{
    ...
    public static partial class DB_TABLE_NAME
    {
        ...
        /// </summary>
        public static string DB_RCS_CPT_ASS_MASTER { get { return Function_Library.GetClassDisplayName<DB_RCS_CPT_ASS_MASTER>(); } }
    }

    [DisplayName("RCS_CPT_ASS_MASTER")]

    public class DB_RCS_CPT_ASS_MASTER
    {
        [Key]
